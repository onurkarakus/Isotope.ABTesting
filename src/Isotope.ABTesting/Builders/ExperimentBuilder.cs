...
public sealed class ExperimentBuilder : IExperimentBuilder
{
    ...
    public IExperimentBuilder UseAlgorithm(Func<AllocationContext, CancellationToken, ValueTask<AllocationResult>> algorithm)
    {
    ...
    public IExperimentBuilder OnFailure(Func<FallbackContext, CancellationToken, ValueTask<AllocationResult>> fallbackHandler)
    {
    ...
    public async Task<AllocationResult> GetVariantAsync(Func<CancellationToken, Task<string>> keyResolver, CancellationToken cancellationToken = default)
    {
